...
function AirFryerForm() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "page-layout", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/spidr-airfryer-form/logo.png", alt: "Spidr Logo", className: "hanging-logo" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("img", { src: "/spidr-airfryer-form/airfryer.png", className: "side-image", alt: "Air Fryer" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-wrapper", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "heading", children: "Spidr Air Fryer Interest Form" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "form", children: [
        ["firstName", "lastName", "phone", "email", "cost", "pin"].map((field, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "form-group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "form-label", children: labelMap[field] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "input-row", children: [
            field === "phone" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "select",
              {
            ...
            field !== "countryCode" && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { minWidth: "160px", marginLeft: "8px" }, children: errors[field] && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { color: "white", fontSize: "12px" }, children: errors[field] }) })
          ] })
        ] }, index)),
        /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "submit-btn", children: "Submit" }),
        success && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "success-message", children: "🎉 Form submitted successfully!" })
      ] })
    ] })
  ] });
}
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AirFryerForm, {}) });
}
